...
BINARY_URL="https://github.com/lumenyx-chain/lumenyx/releases/download/v1.2.0/lumenyx-node"
CHECKSUM_URL="https://github.com/lumenyx-chain/lumenyx/releases/download/v1.2.0/lumenyx-node-v1.2.0-sha256.txt"
